def main():
    ...
    print("GCD: " + str(calculateGCD(a, b)))
    print("Multiplicative Inverse: " + str(calculateMultiplicativeInverse(a, b)))
    biggest = max(a, b)
    print("Z* (relative primes) of " + str(biggest) +
          ": " + str(calculateRelativePrimes(biggest)))
...
def calculateMultiplicativeInverse(b, m):
    ...
    while(B3 > 0):
        print("2. B3=" + str(B3))
        if(B3 == 1):
            print("3. B3=1. Inverse found. B2=" + str(B2))
            while(B2 < 0):
                B2 += m
            return B2
        else:
        ...
        print("5. (T1, T2, T3) := (A1-Q*B1, A2-Q*B2, A3-Q*B3) = (" + str(A1) + "-"+str(Q)+"*" +
              str(B1) + ", " + str(A2)+"-"+str(Q)+"*"+str(B2) + ", " + str(A3)+"-"+str(Q)+"*"+str(B3)+") = (" + str(A1-Q*B1) + ", " + str(A2-Q*B2) + ", " + str(A3-Q*B3) + ")")
        A1, A2, A3 = B1, B2, B3
